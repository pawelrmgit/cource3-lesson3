...
$database = array(  // создаём массив database
    ...
    'about-us' => array (  // добавим внутрь новый массив с информацией о нас
        'adr' => 'ул. Молодогвардейская, д. 58, стр.13, офис 28.',  // Наш адрес
        'worktime' => 'Пн - Пт с 10:00 до 19:00'       // Время работы
    )
